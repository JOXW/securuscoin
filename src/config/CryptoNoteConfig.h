...
namespace CryptoNote
{
    namespace parameters
    {
        ...
        const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX = 0x12d216;
        ...
        const uint64_t MONEY_SUPPLY = UINT64_C(33000000000);
        ...
        const char GENESIS_COINBASE_TX_HEX[] =
            "010a01ff000180a8d6b90702b845e6a416a8eb4defa2545daeb5ab931446a18ff9a9d8ef1a31a1b42f21aebd2101165c2fb3367eae7c3ec098c13dfed099e3e6049a2cd545ead63a67c2af9f042a";
        ...
        /* This is the unix timestamp of the first "mined" block (technically block 2, not the genesis block)
           You can get this value by doing "print_block 2" in SecurusCoind. It is used to know what timestamp
           to import from when the block height cannot be found in the node or the node is offline. */
        const uint64_t GENESIS_BLOCK_TIMESTAMP = 1552424601;
        ...
        const uint64_t BLOCK_BLOB_SHUFFLE_CHECK_HEIGHT = 200000;

        const uint64_t TRANSACTION_INPUT_BLOCKTIME_VALIDATION_HEIGHT = 200000;
    ...
    const char CRYPTONOTE_NAME[] = "SecurusCoin";
    ...
    const int P2P_DEFAULT_PORT = 14114;

    const int RPC_DEFAULT_PORT = 14115;

    const int SERVICE_DEFAULT_PORT = 18114;
    ...
    const char LATEST_VERSION_URL[] = "http://www.securuscoin.org";

    const std::string LICENSE_URL = "https://github.com/JOXW/securuscoin/blob/master/LICENSE";

    const static boost::uuids::uuid CRYPTONOTE_NETWORK = {
        {0xb5, 0x0c, 0x4a, 0x8c, 0xc7, 0x53, 0x74, 0x45, 0x15, 0xf9, 0x91, 0xa4, 0xb4, 0xa4, 0x48, 0xe9}};
