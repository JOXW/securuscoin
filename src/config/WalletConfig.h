...
namespace WalletConfig
{
    ...
    const std::string_view addressPrefix = "SCR";

    /* Your coins 'Ticker', e.g. Monero = XMR, Bitcoin = BTC */
    const std::string ticker = "SCR";
    ...
    const std::string daemonName = "SecurusCoind";
    ...
    /* The name of service/walletd, the programmatic rpc interface to a
       wallet */
    const std::string walletdName = "securus-service";

    /* The full name of your crypto */
    const std::string coinName = std::string(CryptoNote::CRYPTONOTE_NAME);

    /* Where can your users contact you for support? E.g. discord */
    const std::string contactLink = "http://securuscoin.org";
    ...
    /* If a mixin of zero is disabled, at what height was it disabled? E.g.
       ...
       zero is allowed */
    const uint64_t mixinZeroDisabledHeight = CryptoNote::parameters::MIXIN_LIMITS_V3_HEIGHT;
